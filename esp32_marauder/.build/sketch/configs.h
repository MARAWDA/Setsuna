#line 1 "C:\\Users\\wisht\\New folder\\Setsuna\\esp32_marauder\\configs.h"
#pragma once
  ...
  //#define DUAL_MINI_C5
  #define MARAUDER_C5_TOUCH_LCD_28
  //// END BOARD TARGETS
...
#define MARAUDER_VERSION "v1.15.1"
  ...
  #elif defined(MARAUDER_C5_TOUCH_LCD_28)
 ...
 //// BOARD FEATURES
    ...
    #define USE_SD
    #define HAS_DUAL_BAND
    // PSRAM is unusable on this board (MSPI dummy cacheline alloc fails at boot),
    // so HAS_PSRAM must stay undefined - ps_malloc() returns NULL and crashes
    // WiFiScan::RunSetup()'s placement-new otherwise.
    //#define HAS_PSRAM
    //#define HAS_TEMP_SENSOR
    #define HAS_NIMBLE_2
    #define HAS_IDF_3
  ...
  //// CAPACITIVE TOUCH I2C STUFF (boards without a fuel gauge on the same bus)
  #if defined(HAS_CAP_TOUCH) && defined(MARAUDER_C5_TOUCH_LCD_28)
    // CST3530 touch + CH32V003 IO expander share this I2C bus
    #define CTP_SDA 0
    #define CTP_SCL 1
  #endif
  //// END CAPACITIVE TOUCH I2C STUFF
